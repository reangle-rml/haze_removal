...
def main(): # function main เป็นฟังก์ชั่นหลักในการทำงาน
    ...
    collection_ref = db.collection("Images_upload") # สร้างเส้นทางอ้างอิงไปยัง Images ในฐานข้อมูล
    ...
    if uploaded_image is not None: # ถ้ามีการอัปโหลดไฟล์ จะทำตามเงื่อนไข
        ...
        current_timestamp = datetime.now(thailand_zone) # ดึงเวลาปัจจุบันมาเก็บไว้ที่ current_timestamp
